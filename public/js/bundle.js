...
var addtodo = document.querySelector(".button__add");
var close = document.querySelector(".close__icon");
var close__edit = document.querySelector(".close__icon--edit");
var form = document.querySelector(".form__container");
var form__editContainer = document.querySelector(".form__container--edit");
var form__edit = document.querySelector(".form__edit");
var editbuttons = document.querySelectorAll(".button__edit");
...
close__edit.addEventListener("click", function () {
...
form__edit.addEventListener("submit", /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            e.preventDefault();
            id = form__edit.dataset.id;
            newtodo = document.querySelector("#editTodo").value;
            _context.next = 6;
            return _axios.default.patch("update/".concat(id), {
              todo: newtodo
            });
